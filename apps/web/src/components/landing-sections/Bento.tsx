...
let notifications = [
  ...
  },
  {
    ...
    icon: (
      <div className=" h-full flex items-center justify-center w-7">
        {" "}
        <SupMemory />
      </div>
    ),
  ...
  },
  {
    ...
    description: "Lucid",
    icon: (
      <div className=" h-full flex items-center justify-center w-7 rotate-180">
        {" "}
        <Lucid />
      </div>
    ),
          ...
          <div className="border border-dashed border-[#252525] w-full h-full  relative overflow-hidden p-[30px] flex-shrink-0 flex flex-col gap-4 lg:gap-0 ">
            <div className="space-y-1 flex-shrink-0 z-10">
              <motion.h5
                ...
                className="text-2xl lg:text-3xl tracking-tighter text-left"
              >
              ...
              <motion.p
                ...
                className="tracking-tight text-sm lg:text-lg text-[#d1d1d1]"
              >
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center gap-3">
        ...
        >
          <span className="text-lg w-10 lg:aspect-square flex items-center justify-center">
            {icon}
          </span>
        </div>
