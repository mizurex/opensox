      ...
      <div className="">
        <div className="w-full lg:max-w-[1220px] mx-auto border-r border-[#252525]">
          <div className="mx-auto h-full grid lg:grid-cols-2 items-center">
                ...
                {data.map((item, index) => (
                  ...
                  >
                    {linePosition === "left" || linePosition === "right" ? (
                      <div
                        className={`absolute bottom-0 top-0 h-full w-0.5 overflow-hidden rounded-lg bg-purple-950/50  ${
                          linePosition === "right"
                            ? "left-auto right-0"
                            : "left-0 right-auto"
                        }`}
                    ...
                    {linePosition === "top" || linePosition === "bottom" ? (
                      <div
                        className={`absolute left-0 right-0 w-full h-0.5 overflow-hidden rounded-lg bg-purple-500/50 dark:bg-neutral-300/30 ${
            ...
            <div
              className={`lg:h-[485px] md:h-[320px] h-[260px] lg:min-h-[200px] w-auto flex items-center justify-center ${
